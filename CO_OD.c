...
/*6000*/ {0x10, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
...
/*1017*/ 0x3E8, //50000:800ms,0x3E8,        //心跳时间heart time=100毫秒
...
/*发送TPDO的通讯参数设置*/
/*1800主索引--子索引的条数，发送TPDO用的COB-ID，传输类型，禁止时间，兼容入口，事件定时器，同步运行的计数值*/
...
{0x6000/*主索引号*/, 0x08/*子索引的最大数目*/, 0x76,  1/*每个变量的字节数*/, (void*)&CO_OD_RAM.readInput8Bit[0]/*缓冲区入口首地址*/},
{0x6200/*主索引号*/, 0x08/*子索引的最大数目*/, 0x3E,  1/*每个变量的字节数*/, (void*)&CO_OD_RAM.writeOutput8Bit[0]/*缓冲区入口首地址*/},
{0x6401/*主索引号*/, 0x0C/*子索引的最大数目*/, 0xB6,  2/*每个变量的字节数*/, (void*)&CO_OD_RAM.readAnalogueInput16Bit[0]/*缓冲区入口首地址*/},
