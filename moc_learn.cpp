...
**
** Created: Mon Mar 27 20:29:39 2017
...
static const char qt_meta_stringdata_learn[] = {
    "learn\0\0ShowTime()\0on_FinishBtn_clicked()\0"
};
...
const QMetaObjectExtraData learn::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject learn::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_learn,
      qt_meta_data_learn, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &learn::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_learn))
