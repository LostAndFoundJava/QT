...
public:
    ...
    void setupUi(QWidget *learn)
    {
        ...
        DateTime->setGeometry(QRect(515, 10, 230, 31));
...
"color: rgb(255, 250, 240);"));
    ...
    void retranslateUi(QWidget *learn)
    {
        ...
        DateTime->setText(QApplication::translate("learn", "2017/02/01 \346\230\237\346\234\237\346\227\245 13:28", 0, QApplication::UnicodeUTF8));
