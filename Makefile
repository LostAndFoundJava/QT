...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Mar 29 20:06:25 2017
# Project:  Bofeng.pro
# Template: app
...
SOURCES       = can.cpp \
		...
		sqlite.cpp \
		juxingkuang.cpp \
		product.cpp moc_cmysplashscreen.cpp \
		moc_log.cpp \
		moc_mainwindow.cpp \
		moc_management.cpp \
		moc_systemset.cpp \
...
$(TARGET): ui_log.h ui_mainwindow.h ui_management.h ui_systemset.h ui_keyboard.h ui_widget.h ui_learn.h ui_varify.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Bofeng1.0.0/ && $(COPY_FILE) --parents can.h cmysplashscreen.h globl_data.h log.h mainwindow.h management.h systemset.h config.h keyboard.h qmyedit.h widget.h subwidget.h learn.h varify.h sqlite.h juxingkuang.h product.h .tmp/Bofeng1.0.0/ && $(COPY_FILE) --parents Bofeng.qrc .tmp/Bofeng1.0.0/ && $(COPY_FILE) --parents can.cpp cmysplashscreen.cpp globl_data.cpp log.cpp main.cpp mainwindow.cpp management.cpp systemset.cpp config.cpp keyboard.cpp qmyedit.cpp widget.cpp subwidget.cpp learn.cpp varify.cpp sqlite.cpp juxingkuang.cpp product.cpp .tmp/Bofeng1.0.0/ && $(COPY_FILE) --parents log.ui mainwindow.ui management.ui systemset.ui keyboard.ui widget.ui learn.ui varify.ui .tmp/Bofeng1.0.0/ && (cd `dirname .tmp/Bofeng1.0.0` && $(TAR) Bofeng1.0.0.tar Bofeng1.0.0 && $(COMPRESS) Bofeng1.0.0.tar) && $(MOVE) `dirname .tmp/Bofeng1.0.0`/Bofeng1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Bofeng1.0.0
...
compiler_moc_header_make_all: moc_cmysplashscreen.cpp moc_log.cpp moc_mainwindow.cpp moc_management.cpp moc_systemset.cpp moc_keyboard.cpp moc_qmyedit.cpp moc_widget.cpp moc_subwidget.cpp moc_learn.cpp moc_varify.cpp moc_product.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_cmysplashscreen.cpp moc_log.cpp moc_mainwindow.cpp moc_management.cpp moc_systemset.cpp moc_keyboard.cpp moc_qmyedit.cpp moc_widget.cpp moc_subwidget.cpp moc_learn.cpp moc_varify.cpp moc_product.cpp
...
compiler_uic_make_all: ui_log.h ui_mainwindow.h ui_management.h ui_systemset.h ui_keyboard.h ui_widget.h ui_learn.h ui_varify.h
compiler_uic_clean:
	-$(DEL_FILE) ui_log.h ui_mainwindow.h ui_management.h ui_systemset.h ui_keyboard.h ui_widget.h ui_learn.h ui_varify.h
ui_log.h: log.ui
