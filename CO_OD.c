...
/*6000*/ {0x30, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
/*6200*/ {0x31, 0x41, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
/*6401*/ {20.12, 1.0, 0, 0, 0, 0, 0, 0},  //C3 F5 A0 41
...
/*1000*/ 0x0L,
/*1005*/ 0x40000083L,      //同步报文控制字，如果30bit为0则只接收不发送，作为SYNC消费者
/*1006*/ 0x1E8480L,   //同步报文周期（单位us）(2000000:1E8480 1000000:F4240 750000:B71B0 500000:7A120)
/*1007*/ 0xF4240L, //同步报文窗口期 PDO在这个期间发送 资料显示应为报文周期的50%或75%
/*1008*/ {'C', 'A', 'N', 'o', 'p', 'e', 'n', 'N', 'o', 'd', 'e'},
/*1009*/ {'3', '.', '0', '0'},
/*100A*/ {'3', '.', '0', '0'},
/*1014*/ 0x80L,   //紧急报文COB标识符
/*1015*/ 0x2710,    //紧急报文禁止时间（单位100us）(10000:2710 5000:1388 1000:3E8)
/*1016*/ {0x0L, 0x0L, 0x0L, 0x0L},   //心跳时间消费者间隔（单位ms），32bit（0-15bit是心跳时间，16-23bit是监视的nodeID,24-31bit保留为0）
/*1017*/ 0xBB8,   //心跳生产者时间间隔（单位ms）（5000:1388 4000:FA0 3000:BB8 2000：7D0 1000：3E8 750：2EE 500：1F4）
/*1018*/ {0x4, 0x0L, 0x0L, 0x0L, 0x0L},
/*1019*/ 0x0,     //同步计数溢出值,如果溢出值为0，则发送不含同步计数器的同步报文,否则发送一个字节从1开始递增计数的同步计数器
/*1029*/ {0x0, 0x0, 0x1, 0x0, 0x0, 0x0},

//SDO服务参数：条数  客户到服务器COB-ID  服务器到客户COB-ID
/*1200*/{{0x2, 0x600L, 0x580L}},

/*接受RPDO的通讯参数设置*/
/*子目录的条数，COB-ID，接受RPDO传输类型FF==设备协议相关的事件异步传输，FE==制造商相关事件异步传输*/
...
/*接受RPDO的映射参数设置*/
/*1600是针对1400号索引--子目录的条数，第一个变量缓冲区入口个数及类型，共两个，入口地址0x6200，变量类型8位--08，变量类型16位--10，
  变量类型32位--20*/
/*1600*/{{0x0, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L},
/*1601是针对1401号索引--子目录的条数，第一个变量缓冲区入口个数及类型*/
...
/*发送TPDO的通讯参数设置*/
/*1800主索引--子索引的条数，发送TPDO用的COB-ID，传输类型，禁止时间(单位100us），兼容入口，事件定时器(单位ms)，同步运行的计数值(0-240)*/
/*1800*/{{0x6, 0x202L, 0x04, 0x0A, 0x0, 0x0, 0x0},
/*1801*/ {0x6, 0x302L, 0x02, 0x0A, 0x0, 0x0, 0x0},
...
/*发送TPDO的映射参数设置*/
/*1A00是针对1800的主索引号--子索引的条数，第一个变量缓冲区入口个数及类型，第二个变量缓冲区入口个数及类型
/*1A00*/{{0x2, 0x62000108L, 0x62000208L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L},
/*1A01*/ {0x2, 0x64010120L, 0x64010220L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L, 0x0L},
...
/*1F80*/ 0x4L,     // NMTstartup 该值为0x04表示上电由NMT启动节点，否则自动进入运行状态
...
/*这个区域负责通讯参数的设置 SDO*/
{0x1200/*主索引号*/, 0x02/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1200/*缓冲区入口首地址*/},
{0x1280, 0x03, 0x00,  0, (void*)&OD_record1280},

/*这个区域负责通讯参数的设置 RPDO*/
{0x1400/*主索引号*/, 0x02/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1400/*缓冲区入口首地址*/},
{0x1401/*主索引号*/, 0x02/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1401/*缓冲区入口首地址*/},
{0x1402/*主索引号*/, 0x02/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1402/*缓冲区入口首地址*/},
{0x1403/*主索引号*/, 0x02/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1403/*缓冲区入口首地址*/},
...
/*这个区域负责映射参数的设置 RPDO*/
{0x1600/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1600/*缓冲区入口首地址*/},
{0x1601/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1601/*缓冲区入口首地址*/},
{0x1602/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1602/*缓冲区入口首地址*/},
{0x1603/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1603/*缓冲区入口首地址*/},
...
/*这个区域负责通讯参数的设置 TPDO*/
{0x1800/*主索引号*/, 0x06/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1800/*缓冲区入口首地址*/},
{0x1801/*主索引号*/, 0x06/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1801/*缓冲区入口首地址*/},
{0x1802/*主索引号*/, 0x06/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1802/*缓冲区入口首地址*/},
{0x1803/*主索引号*/, 0x06/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1803/*缓冲区入口首地址*/},
...
/*这个区域负责映射参数的设置 TPDO*/
{0x1A00/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1A00/*缓冲区入口首地址*/},
{0x1A01/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1A01/*缓冲区入口首地址*/},
{0x1A02/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1A02/*缓冲区入口首地址*/},
{0x1A03/*主索引号*/, 0x08/*子索引的最大数目*/, 0x00/*属性或名称的代码*/,  0, (void*)&OD_record1A03/*缓冲区入口首地址*/},
...
/*这个区域是负责固定特定协议的设置，主要关照0x2101描述的CAN节点号---0x2102描述的通讯波特率*/
...
/*这个区域是负责映射参数的设置，链接到缓冲区入口地址*/
{0x6000/*主索引号*/, 0x08/*子索引的最大数目*/, 0x3E,  1/*每个变量的字节数*/, (void*)&CO_OD_RAM.readInput8Bit[0]/*缓冲区入口首地址*/},
{0x6200/*主索引号*/, 0x08/*子索引的最大数目*/, 0x7E,  1/*每个变量的字节数*/, (void*)&CO_OD_RAM.writeOutput8Bit[0]/*缓冲区入口首地址*/},
{0x6401/*主索引号*/, 0x08/*子索引的最大数目*/, 0xFE,  4/*每个变量的字节数*/, (void*)&CO_OD_RAM.readAnalogueInput32Bit[0]/*缓冲区入口首地址*/},
{0x6411/*主索引号*/, 0x08/*子索引的最大数目*/, 0xBE,  2/*每个变量的字节数*/, (void*)&CO_OD_RAM.writeAnalogueOutput16Bit[0]/*缓冲区入口首地址*/},
};
