...
# Generated by qmake (2.01a) (Qt 4.7.3) on: ?? 4? 9 15:51:37 2017
# Project:  QT.pro
# Template: app
# Command: /home/vmuser/nfs_shared/qt-4.7.3-arm/bin/qmake -o Makefile QT.pro
#############################################################################
...
Makefile: QT.pro  ../../../nfs_shared/qt-4.7.3-arm/mkspecs/qws/linux-arm-gnueabi-g++/qmake.conf ../../../nfs_shared/qt-4.7.3-arm/mkspecs/common/g++.conf \
		../../../nfs_shared/qt-4.7.3-arm/mkspecs/common/unix.conf \
		../../../nfs_shared/qt-4.7.3-arm/mkspecs/common/linux.conf \
		../../../nfs_shared/qt-4.7.3-arm/mkspecs/common/qws.conf \
		../../../nfs_shared/qt-4.7.3-arm/mkspecs/qconfig.pri \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QT1.0.0/ && $(COPY_FILE) --parents application.h CANopen.h cmysplashscreen.h CO_comm_helpers.h CO_command.h CO_driver.h CO_Emergency.h CO_HBconsumer.h CO_Linux_tasks.h CO_master.h CO_NMT_Heartbeat.h CO_OD.h CO_OD_storage.h CO_PDO.h CO_SDO.h CO_SDOmaster.h CO_SYNC.h CO_time.h CO_trace.h config.h crc16-ccitt.h dataset.h globl_data.h juxingkuang.h keyboard.h learn.h log.h mainwindow.h management.h notice.h product.h qmyedit.h sqlite.h subwidget.h systemset.h thread_canopen.h varify.h widget.h .tmp/QT1.0.0/ && $(COPY_FILE) --parents Bofeng.qrc .tmp/QT1.0.0/ && $(COPY_FILE) --parents application.c CANopen.c cmysplashscreen.cpp CO_comm_helpers.c CO_command.c CO_driver.c CO_Emergency.c CO_HBconsumer.c CO_Linux_tasks.c CO_master.c CO_NMT_Heartbeat.c CO_OD.c CO_OD_storage.c CO_PDO.c CO_SDO.c CO_SDOmaster.c CO_SYNC.c CO_time.c CO_trace.c config.cpp crc16-ccitt.c dataset.cpp globl_data.cpp juxingkuang.cpp keyboard.cpp learn.cpp log.cpp main.cpp mainwindow.cpp management.cpp notice.cpp product.cpp qmyedit.cpp sqlite.cpp subwidget.cpp systemset.cpp thread_canopen.cpp varify.cpp widget.cpp .tmp/QT1.0.0/ && $(COPY_FILE) --parents dataset.ui keyboard.ui learn.ui log.ui mainwindow.ui management.ui notice.ui systemset.ui varify.ui widget.ui .tmp/QT1.0.0/ && (cd `dirname .tmp/QT1.0.0` && $(TAR) QT1.0.0.tar QT1.0.0 && $(COMPRESS) QT1.0.0.tar) && $(MOVE) `dirname .tmp/QT1.0.0`/QT1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QT1.0.0
