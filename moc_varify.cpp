...
**
** Created: Wed Mar 29 20:41:11 2017
...
void varify::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        varify *_t = static_cast<varify *>(_o);
        switch (_id) {
        case 0: _t->ShowTime(); break;
        case 1: _t->on_DropOut_clicked(); break;
        case 2: _t->on_SetZero_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData varify::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject varify::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_varify,
      qt_meta_data_varify, &staticMetaObjectExtraData }
};
